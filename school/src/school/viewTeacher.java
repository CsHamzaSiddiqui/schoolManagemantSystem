...
public class viewTeacher extends javax.swing.JPanel {
    teacherDAO stDAO = new teacherDAO();
    /**
    ...
    public void setValues(){
        List<teacher> teachers = stDAO.findAll();
        setTable(jTable1, teachers);
    }

    public void setTable(JTable table, List<teacher> teachers){
        ...
        for(teacher teach:teachers){
            String data[]={
                String.valueOf(teach.getPersonalNo()),
                String.valueOf(teach.getOrderNo()),
                teach.getName(),
                teach.getBPS(),
                teach.getCNIC(),
                teach.getEmailAddress(),
                teach.getReligion(),
                teach.getCast(),
                teach.getSpouceName(),
                String.valueOf(teach.getDOJ()),
                String.valueOf(teach.getDOR())
            };
            dtm.addRow(data);
        }
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Personal No.", "Order No", "Name", "BPS", "CNIC", "Email Address", "Religion", "Cast", "Spouce Name", "Joining", "Regularization"
            }
        ));
    ...
    private void nameKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_nameKeyReleased
        ...
        pop.setCustomPopup(name.getText(), nameList, namePopup, "teacher","name");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        List<teacher> stList=stDAO.getNameByAlpha(name.getText());
